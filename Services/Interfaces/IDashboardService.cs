...
namespace POSRestoran01.Services.Interfaces
{
    public interface IDashboardService
    {
        ...
        Task<List<PopularMenuViewModel>> GetPopularMenusAsync(DateTime? startDate, DateTime? endDate, int limit = 10);
        ...
        Task<DashboardStatsViewModel> GetDashboardStatsRangeAsync(DateTime startDate, DateTime endDate);
    }
}